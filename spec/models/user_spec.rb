...
describe User do
  ...
  it "should accept names that aren't too long" do
    long_name = "a" * 50
  ...
  it "should reject case-insensitive duplicate email addresses" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email with no user" do
        non_existent_user = User.authenticate("doesnt@exist.com", @attr[:password])
